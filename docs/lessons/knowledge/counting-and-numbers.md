# KNOWLEDGE EXPLORATION: Counting and Numbers
...
**Recommended video**: Search YouTube for "Counting 1-5 for Toddlers" or "Learn to Count with Super Simple Songs"

**What to look for**:
- 2-5 minutes long
- Clear, slow numeral display matching spoken numbers
- Repetition of the same counting sequence multiple times
- Bright colors and engaging visuals
- Familiar items (blocks, apples, fingers) shown during counting
- No scary elements or sudden loud noises

**Alternative searches**:
- "Toddler counting songs 1 to 10"
...
**Essential**:
- 10-15 small objects (blocks, pompoms, cheerios, buttons, or pasta pieces)
- A shallow container or basket
- Your hands and fingers

**Optional**:
- Picture cards showing numerals (1, 2, 3, 4, 5)
- Small paper cups or bowls for sorting
- Printed or drawn numerals on cardstock
...
**Preparation**:
1. Gather small objects that are safe for your child's age (nothing smaller than a marble for younger toddlers)
2. Clean objects if needed
3. Ensure clear space on a low table or floor where your child can easily reach and see
...
**Variation 1 - Counting Around the House**: Count household items throughout the day. Count stairs as you go up them, count dishes as you wash them, count your steps to the door. This shows that numbers are everywhere.

**Variation 2 - Counting with Snacks**: Use small food items (cheerios, grapes cut in half, crackers). Count together, then the child gets to eat what they counted. This adds motivation and makes the learning meaningful.

**Repeat Play**: Use different objects each time to maintain interest—buttons, blocks, pompoms, leaves, rocks. The changing objects keep the activity fresh while the counting skill stays the same. Even 2-3 year-olds will engage repeatedly if the objects change.
...
1. **Number Recognition Hunt**: Hide numeral cards (1, 2, 3) around a room. Find them together and count objects to match (find the "2" card, then count out 2 blocks). This connects written symbols to quantity.
...
**Category**: Mathematical & Technological Systems (Cognitive Skills)
