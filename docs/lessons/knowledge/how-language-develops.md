# KNOWLEDGE EXPLORATION: How Language Develops
...
**Recommended video**: Search YouTube for "How Babies Learn to Talk | Educational Video for Preschoolers"

**What to look for**:
- 2-5 minutes long
- Age-appropriate narration (slow, clear speech)
- Visually engaging (bright colors, animated or real-life examples)
...
**Essential**:
- Hand mirror (or small mirrors for each child)
- Picture cards with simple objects (cat, dog, ball, sun, house)
- Items that make sounds (wooden spoon, plastic lid, bell, rattle)
- Chart paper and markers

**Optional**:
- Age-appropriate picture books about feelings or animals
- Recording device (phone/tablet) to record child's voice
- Colored tape for marking "stations"
- Soft animal puppets or stuffed animals

**Cost**: Free (uses household items) to Under $5 (if purchasing mirrors)

### Step-by-Step Instructions

**Preparation**:
1. Set up 3-4 "stations" around your play space: a Sound Station with items that make noise, a Mirror Station with a hand mirror, a Picture Station with object cards, and a Gesture Station with open floor space.
2. Arrange seating or floor space so children can move safely between stations.
3. Test all materials to ensure safety (no small choking hazards, mirrors secure and safe).
