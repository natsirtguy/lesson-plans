...
class MasteryParams:
    ...
    def from_settings(cls, settings: Settings) -> MasteryParams:
        ...
        return cls(
            ...
            confidence_damping=settings.confidence_damping,
            ...
            prereq_bound_slack=settings.prereq_bound_slack,
            prior_trust_confidence=settings.prior_trust_confidence,
            prior_retention=settings.prior_retention,
            tier_prior_strength=settings.tier_prior_strength,
